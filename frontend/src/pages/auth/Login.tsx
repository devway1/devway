        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-gray-400 hover:text-primary-light transition-colors font-arabic-medium underline pb-2">
                هل نسيت الرقم السري؟
              </Link>
            </div>
            ...
            <div className="text-center">
              <span className="text-gray-500 lg:text-xl">هل انت لسه مشترك؟&nbsp;&nbsp;</span>
              <Link to="/register" className="lg:text-xl underline text-primary hover:text-primary-light transition-colors font-arabic-medium">
                اشتراك
              </Link>
            </div>
          </form>
